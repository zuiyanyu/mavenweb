 ...
 *      1.2.2 一个可运行的线桿可能正在运行也可能没有运行， 这取决于操作系统给线程提供运行的时间。
 ...
 *
 * 1.3 被阻塞线程和等待线程 1.3 Blocked (被阻塞)、   1.4 Waiting (等待) 、 1.5 Timed Waiting (计时等待)
 ...
 *
 *      1.3.3 TODO 当一个线程被阻塞或等待时（或终止时，) 另一个线程被调度为运行状态。
